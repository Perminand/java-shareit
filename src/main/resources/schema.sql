...
create table if not exists bookings (
    ...
    status varchar(255) check (status in ('WAITING','APPROVED','REJECTED','CANCELED')) not null,
...
CONSTRAINT comments_users_fk FOREIGN KEY (autor_id) REFERENCES users(id) ON delete CASCADE
);
